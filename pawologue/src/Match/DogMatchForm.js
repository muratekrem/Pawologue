    ...
    return (
        ...
        <div className="container">
            ...
            <form id="pet-form" onSubmit={handleSubmit}>
                ...
                <select id="feature1" name="feature1" value={features.feature1} onChange={handleChange}>
                ...
                <select id="feature2" name="feature2" value={features.feature2} onChange={handleChange}>
                ...
                <select id="feature3" name="feature3" value={features.feature3} onChange={handleChange}>
                ...
                <select id="feature4" name="feature4" value={features.feature4} onChange={handleChange}>
                ...
                <select id="feature5" name="feature5" value={features.feature5} onChange={handleChange}>
                    <option value="01">Brown</option>
                    <option value="10">Blue</option>
                </select>

                <label htmlFor="feature6">Age:</label>
                <select id="feature6" name="feature6" value={features.feature6} onChange={handleChange}>
                ...
                <select id="feature7" name="feature7" value={features.feature7} onChange={handleChange}>
                ...
                <select id="feature8" name="feature8" value={features.feature8} onChange={handleChange}>
            ...
            {result && (
                <div id="result">
                    Recommended Indices: {result.join(', ')}
                </div>
            )}
        </div>
        </div>
        ...
        <div className="column">
          <h3 style={{display:"flex", justifyContent:"center"}}>Listing Dogs For Waiting Partners </h3>
                  ...
                  <div key={index} className="pet-card">
                    <div className="pet-content">
                      ...
                      <div className="pet-details">
                        ...
                        <div className="pet-info-text">Country Of Origin: {pet.countryOfOrigin}</div>
                        <div className="pet-info-text">Fur Color: {pet.furColor}</div>
                        <div className="pet-info-text">Height: {pet.height}</div>
                        <div className="pet-info-text">Eye Color: {pet.eyeColor}</div>
                        <div className="pet-info-text">Age: {pet.age}</div>
                        <div className="pet-info-text">Character: {pet.character}</div>
                        <div className="pet-info-text">Health: {pet.health}</div>
